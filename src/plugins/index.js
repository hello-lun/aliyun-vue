...
const wiierror = {
  ...
  report_performance() {
    /* performance 对象 */
    var performance =
      window.webkitPerformance || window.msPerformance || window.performance;
    /* 所需信息 */
    var points = [
      "navigationStart" /* 开始浏览的时间 */,
      "unloadEventStart",
      "unloadEventEnd" /* 卸载上一个页面的时间 */,
      "redirectStart",
      "redirectEnd" /* HTTP重定向所消耗的时间 */,
      "fetchStart",
      "domainLookupStart" /* 缓存加载的时间 */,
      "domainLookupStart",
      "domainLookupEnd" /* DNS查询的时间 */,
      "connectStart",
      "connectEnd" /* 建立TCP连接的时间 */,
      "connectStart",
      "requestStart",
      "responseStart",
      "responseEnd" /* 建立TCP连接的时间 */,
      "domInteractive" /* 可以交互的时间 */,
      "domContentLoadedEventStart",
      "domContentLoadedEventEnd" /* DomContentLoaded  页面加载完成的时间*/,
      "domLoading",
      "domComplete" /* 页面渲染的时间 */,
      "domLoading",
      "navigationStart" /* 加载页面花费的总时间 */,
      "loadEventStart",
      "loadEventEnd" /* 加载事件的时间 */,
      "jsHeapSizeLimit",
      "totalJSHeapSize",
      "usedJSHeapSize" /* 内存的使用情况 */,
      "redirectCount",
      "type" /* 页面重定向的次数和类型 */
    ];
    /* 性能对象的属性 */
  ...
  init() {
    ...
    Vue.config.errorHandler = (error, vm, info) => {
      ...
      wiierror.options.stack = ErrorStackParser.parse(error);
      wiierror.options.data = {
        category: "vue",
